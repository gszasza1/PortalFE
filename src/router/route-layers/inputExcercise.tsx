...
import { GeneralInputExcercise } from '../../pages/excercises/input-answer/general/component';
...
const InputExcerciseRouterLayer = (props: RouteComponentProps) => {
  return (
    <Switch>
      ...
      <Route path={props.match.url + INPUT_EXCECISE_PATH.EDIT} exact>
        <EditInputExcerciseForm {...props}></EditInputExcerciseForm>
      </Route>
      <Route
